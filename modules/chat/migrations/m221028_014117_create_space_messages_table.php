...
/**
 * Handles the creation of table `{{%space_message}}`.
 */
class m221028_014117_create_space_messages_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex('reply_id', $this->tableName(), 'reply_id');
