...
class ConcernSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['ConcernSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'ConcernSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
