...
class AnnouncementSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['AnnouncementSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'AnnouncementSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
