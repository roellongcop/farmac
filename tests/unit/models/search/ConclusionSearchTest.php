...
class ConclusionSearchTest extends \Codeception\Test\Unit
{
    ...
    public function testSearchWithResult()
    {
        ...
        $dataProviders = $searchModel->search(['ConclusionSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'ConclusionSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
