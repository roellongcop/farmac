...
<div id="<?= $widgetId ?>" class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="top">
    <a href="#" class="btn btn-bg-white btn-text-dark-50 btn-hover-text-primary btn-icon-primary font-weight-bolder font-size-sm px-5 mr-3 btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
