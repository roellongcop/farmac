...
<div class="card card-custom card-stretch gutter-b">
	<div class="card-body">
		<div id="carousel-event" class="carousel slide" data-ride="carousel" data-interval="8000">
			<div class="d-flex align-items-center justify-content-between flex-wrap">
				...
				<div class="p-0">
					...
					<a href="#carousel-event" class="btn btn-icon btn-light btn-sm" role="button" data-slide="next">
						<span class="svg-icon svg-icon-md">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									<polygon points="0 0 24 0 24 24 0 24"></polygon>
						...
						<div class="carousel-item {$class}">
							...
							<div class="mt-10 border-0 d-flex align-items-center justify-content-between pt-0">
								<span class="label label-lg label-light-primary label-inline font-size-sm font-weight-bolder py-5">
									{$event->getCreatedDateFormat('d M y')}
								</span>
								<a href="{$url}" class="btn btn-sm btn-primary font-weight-bolder px-6">Calendar</a>
							</div>
						</div>
					HTML;
				}) ?>
